...
namespace TextureAtlasSlicer.Editor
{
    public class TextureAtlasSlicer : EditorWindow
    {
        ...
        public void OnGUI()
        {
            ...
            EditorGUI.BeginDisabledGroup(focusedWindow != this);
            {
                                             ...
                                             importer.textureType != TextureImporterType.Default);
                {
                    ...
                    if (EditorGUI.EndChangeCheck()) ParseXML();
                    ...
                    if (GUILayout.Button("Slice")) PerformSlice();
                    EditorGUI.EndDisabledGroup();
                }
                EditorGUI.EndDisabledGroup();
            }
        ...
        private void ParseXML()
        {
            try
            {
                ...
                if (root == null || root.Name != "TextureAtlas") return;
